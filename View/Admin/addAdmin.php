...
<div id="addAdminForm">
    <form action="../../Controller/Admin/addAdmin.php" onsubmit="return chkinput(this)" method="POST">
        ...
        <div class="col-span-6 sm:col-span-3 w-full">
                  ...
                  <input type="password" name="mdp" id="password" autocomplete="family-name" class="mt-1 focus:ring-[#E4DE4B] focus:border-[#E4DE4B] block w-full p-3 shadow-sm sm:text-sm border-gray-300 rounded-md">
        </div>
